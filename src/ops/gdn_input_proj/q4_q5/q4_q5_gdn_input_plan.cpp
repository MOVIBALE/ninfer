...
constexpr std::array<RouteSpec, 5> kRoutes{{
    ...
    {{13, 31}, Q4Q5GdnInputScheduleId::GroupedMixedMmaR32C32S2},
    {{32, 32}, Q4Q5GdnInputScheduleId::GroupedMixedMmaR32C32K128S2},
...
const char* q4_q5_gdn_input_schedule_name(Q4Q5GdnInputScheduleId schedule) noexcept {
    ...
    case Q4Q5GdnInputScheduleId::GroupedMixedMmaR32C32K128S2:
        return "gdn_input_proj.q4_q5.grouped_mixed.mma.r32.c32.k128.s2";
