...
int run_q4_q5() {
    ...
    // the per-side small-column kernels (the K-split Q4 parent with the split4 Q5 side at 2..9 and
    // the c4 SIMT Q5 side at 10..12), 13..32 to the 32x32 tile, 33..64 to the 32x64 tile, and 65
