...
int q5_a16_conformance() {
    ...
    // The lists cover both sides of every route boundary the shape tables declare: the narrow-column
    // tiles end at 48/160/512 here, at 11/112 for the k5120 row geometries and at 15/112/256 for the
    // 5120-row ones.
    constexpr std::array kN1024K5120{
        convenience(1), a16(4),   a16(5),   a16(16),  a16(17),  a16(48), a16(49),
        a16(160),       a16(161), a16(512), a16(513), a16(640), a16(128), a16(1280),
    };
